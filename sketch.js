...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
       ...
       var diamonds = createSprite(width+120,height-300,40,10);
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(width+120,height-300,40,10);
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(width+120,height-300,40,10);
